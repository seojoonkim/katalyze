  ...
  return (
    <footer className="border-t border-white/10 bg-black/60 py-12">
      <div className="container-shell grid gap-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          <p className="font-display text-4xl tracking-[0.16em] text-[#C4913E]">KATALYZE</p>
        ...
        <div>
          <p className="mb-4 text-sm uppercase tracking-[0.24em] text-[#C4913E]">Navigate</p>
        ...
        <div>
          <p className="mb-4 text-sm uppercase tracking-[0.24em] text-[#C4913E]">Newsletter</p>
          <div className="k-card rounded-none p-4">
            ...
            <button className="w-full rounded-none bg-[#C4913E] px-4 py-3 text-base font-semibold text-black">Get festival updates</button>
          </div>
        </div>
      </div>
    </footer>
