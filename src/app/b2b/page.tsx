    ...
    <div>
      ...
      <AnimatedSection className="section-pad">
        <div className="container-shell grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-3 text-sm uppercase tracking-[0.4em] text-[#C4913E]">KATALYZE CONNECT</p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-6">
              <div className="border-l-2 border-[#C4913E] pl-4">
          ...
          <div className="border border-white/10 bg-white/[0.02] p-8">
            <p className="font-outfit text-sm uppercase tracking-[0.3em] text-[#C4913E] mb-6">Why CONNECT?</p>
            <ul className="space-y-5">
              {["단 2일 안에 한국 최고 브랜드와 직접 미팅", "검증된 바이어만 참가 — 퀄리티 보장", "AI 큐레이션으로 적합한 브랜드만 매칭", "팔로우업 지원 및 계약 협상 공간 제공"].map((item, i) => (
                <li key={i} className="flex items-start gap-3 font-outfit text-base leading-6 text-white/85">
                  <span className="mt-0.5 text-[#C4913E] text-base">→</span>
                  {item}
                </li>
              ))}
            </ul>
              ...
              <div className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-white/20 bg-white/5 px-4 py-3 font-outfit text-base text-white placeholder-white/30 focus:border-[#C4913E] focus:outline-none"
                      placeholder="Name"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-white/20 bg-[#0D0D10] px-4 py-3 font-outfit text-base text-white focus:border-[#C4913E] focus:outline-none"
                  >
                ...
                <button
                  ...
                  className="w-full bg-[#C4913E] py-4 text-base font-bold uppercase tracking-[0.4em] text-black transition hover:bg-[#D4A84A]"
                >
                  신청하기
                </button>
              </div>
            ) : (
              <div className="border border-[#C4913E]/30 bg-[#C4913E]/5 p-8 text-center">
