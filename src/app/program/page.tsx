...
export default function ProgramPage() {
  return (
    <div>
      <PageHero title="Programming for impact, not filler" eyebrow="Program" description="Each hour is designed to build discovery, energy, and conversion across audiences." image="/images/concert_stage.jpg" />
