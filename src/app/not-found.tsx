...
export default function NotFound() {
  return (
    <div className="container-shell flex min-h-[70vh] flex-col items-center justify-center text-center">
      <p className="text-sm uppercase tracking-[0.3em] text-[#F0B429]">404</p>
      ...
      <Link href="/" className="mt-8 rounded-none bg-[#F0B429] px-5 py-3 text-base font-semibold uppercase tracking-[0.16em] text-black">Go home</Link>
    </div>
  );
}
