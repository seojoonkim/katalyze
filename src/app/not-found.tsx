...
export default function NotFound() {
  return (
    <div className="container-shell flex min-h-[70vh] flex-col items-center justify-center text-center">
      ...
      <p className="mt-4 max-w-md text-white/70">The signal got lost. Return to the main festival landing page.</p>
      <Link href="/" className="mt-8 rounded-none bg-[#d4af37] px-5 py-3 text-sm font-semibold uppercase tracking-[0.16em] text-black">Go home</Link>
    </div>
  );
}
